...
class TrustpilotIngestor(BaseIngestor):
    ...
    def __init__(self):
        super().__init__()
        self.api_key = self.secrets.get('trustpilot_api_key', '')
        self.api_secret = self.secrets.get('trustpilot_api_secret', '')
        self.business_unit_id = self.secrets.get('trustpilot_business_unit_id', '')
